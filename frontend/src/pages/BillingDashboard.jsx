...
:root{
  /* Map page-local tokens to global theme tokens so this page flips with light/dark. */
  --navy: var(--accent-strong, #115e59);
  --navy2: var(--accent-hover, #0f766e);
  --bg2: var(--surface-2);
  --white: var(--surface);
  ...
  --tealBg: var(--accent-soft);
  --amber: var(--warning);
  --amberBg: var(--warning-soft);
  --red: var(--danger);
  --redBg: var(--danger-soft);
  --blue: var(--info);
  --blueBg: var(--info-soft);
  --green: var(--success);
...
.pgt{font-family:var(--ui-font-sans);font-size:26px;color:var(--text);font-weight:800;letter-spacing:-.02em}

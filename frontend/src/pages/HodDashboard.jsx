    ...
    try {
      ...
      if (summContent?.sections) {
        summContent.sections = summContent.sections.map(sec => {
          ...
          const keyAliases = {
            chiefComplaints:      disData.chiefComplaints     || medData.chiefComplaints    || medData.presentComplaints || disData.complaints || "",
            historyOfIllness:     disData.historyOfIllness    || medData.historyOfIllness   || "",
            investigations:       disData.investigations      || medData.investigations     || "",
            diagnosis:            disData.diagnosis           || medData.provisionalDiagnosis|| "",
            treatmentGiven:       disData.treatmentGiven      || medData.treatmentAdvised   || disData.treatment || "",
            conditionAtDischarge: disData.conditionAtDischarge|| disData.dischargeStatus    || disData.condition || "",
            adviceOnDischarge:    disData.adviceOnDischarge   || disData.followUp           || disData.instructions || "",
            followUp:             disData.followUp            || disData.follow_up          || "",
            reasonForLama:        disData.reasonForLama       || "",
            referredTo:           disData.referredTo          || "",
            lamaDeclaration:      disData.lamaDeclaration     || "",
            reasonForDopr:        disData.reasonForDopr       || "",
            notes:                disData.notes               || "",
          };
          const savedVal = keyAliases[sec.key] || disData[sec.key] || medData[sec.key] || "";

    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", background: "#f5f3ff", color: "#1e1b4b", fontFamily: "'Inter', 'Segoe UI', sans-serif", overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 28px", height: 48, borderBottom: "1.5px solid #ddd6fe", background: "#f5f3ff", flexShrink: 0 }}>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          {viewTab === "entry" && (
            <>
              {hasUnsaved && <div style={{ fontSize: 10, color: "#f59e0b", animation: "upulse 2s infinite", fontFamily: "'DM Mono', monospace", fontWeight: 600 }}>● Unsaved changes</div>}
              {savedAt && !hasUnsaved && <div style={{ fontSize: 10, color: "#10b981", fontFamily: "'DM Mono', monospace", fontWeight: 600 }}>✓ Saved at {savedAt}</div>}
              <button className="uaction-btn" onClick={() => addRows(5)} style={{ padding: "6px 16px", borderRadius: 8, fontSize: 11, fontFamily: "'Inter', sans-serif", cursor: "pointer", background: "#fff", border: "1.5px solid #ddd6fe", color: "#6b7280", fontWeight: 600 }}>+ 5 Rows</button>
              <button className="uaction-btn" onClick={handleSave} style={{ padding: "6px 20px", borderRadius: 8, fontSize: 12, fontFamily: "'Inter', sans-serif", cursor: "pointer", background: `linear-gradient(135deg, ${accent}, #6366f1)`, border: "none", color: "#fff", fontWeight: 700, boxShadow: `0 4px 14px ${accent}50` }}>💾 Save</button>
            </>
          )}
        </div>
      </div>
                          ...
                          <td key={col.key} style={{ padding: 0, borderRight: "1px solid #ede9fe" }}>
                            {col.readOnly ? (
                              ...
                              <input
                                ...
                                style={{ width: "100%", padding: "10px 14px", background: "transparent", border: "none", color: col.key === "patientName" ? "#1e1b4b" : "#374151", fontSize: 11, fontFamily: "'DM Mono', monospace", outline: "none", minWidth: col.width, cursor: "text", fontWeight: col.key === "patientName" ? 600 : 400 }}

...
export default function NursingDashboard({ currentUser, onLogout }) {
  ...
  const source = filteredEntries.length
    ? filteredEntries
    : rows.filter(r => r.uhid || r.claimId || r.patientName);
  ...
  XLSX.utils.book_append_sheet(wb, ws, "Nursing Log");
  XLSX.writeFile(wb, `Sangi_Nursing_${filterMode}_${today}.xlsx`);
};
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, flexShrink: 0 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 16, fontWeight: 700, color: "var(--text)", letterSpacing: "-0.3px", whiteSpace: "nowrap" }}>Nursing Departmen</div>
          </div>
          <div style={{
            ...
            <>
              <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
                ...
                <div style={{ minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 9, color: "var(--text-muted)", letterSpacing: "1.5px", textTransform: "uppercase" }}>NursingStaff</div>
                </div>
              </div>
              <button
                onClick={onLogout}

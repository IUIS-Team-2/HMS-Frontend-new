      ...
      <header style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"0 26px", height:64, borderBottom:"1px solid var(--border)", background:"var(--surface)", flexShrink:0 }}>
        <div style={{ display:"flex", alignItems:"center", gap:14 }}>
          ...
          <div>
            ...
            <div style={{ fontSize:18, fontWeight:700, color:"var(--text)", letterSpacing:"-0.4px", marginTop:1 }}>Nursing Dashboard</div>
          </div>
          ...
          {currentUser && (
            <div style={{ display:"flex", alignItems:"center", gap:9, marginLeft:8, paddingLeft:14, borderLeft:"1px solid var(--border)" }}>
              ...
              <div>
                ...
                <div style={{ fontSize:10, color:"var(--text-dim)", textTransform:"uppercase", letterSpacing:"1px", fontWeight:500 }}>Nursing Staff</div>
              </div>
        ...
        {viewTab === "entry" && (
          <div style={{ flex:1, overflow:"auto", padding:"20px 26px" }} className="ns_fade">
            ...
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:18, padding:"14px 22px", background:"var(--surface)", border:`1px solid ${COLOR}35`, borderRadius:12, borderLeft:`4px solid ${COLOR}` }}>
              <div>
                <div style={{ fontSize:14, fontWeight:700, color:"var(--text)" }}>Daily Nursing Log — {today}</div>
                <div style={{ fontSize:12, color:"#4f5875", marginTop:4, fontWeight:500 }}>
                  ...
                  <span style={{ color:"var(--text-dim)", marginLeft:12 }}>Tab = next column · Enter = next row</span>
                </div>
              </div>
                ...
                <table style={{ borderCollapse:"collapse", width:"100%", minWidth:"max-content" }}>
                  ...
                  <tbody>
                    {rows.map((row, ri) => {
                      ...
                      return (
                        <tr key={row.id} className="ns_tr" style={{ background: filled ? "#0d1a12" : "transparent", borderBottom:"1px solid var(--border)" }}>
                          {COLUMNS.map(col => (
                  ...
                  <table style={{ borderCollapse:"collapse", width:"100%", minWidth:"max-content" }}>
                    ...
                    <tbody>
                      {filteredEntries.map((row, i) => (
                        <tr key={row.id||i} className="ns_tr" style={{ borderBottom:"1px solid var(--border)" }}>
                          ...
                          <td style={{ padding:"10px 14px", color:"#a7f3d0", fontSize:12, fontFamily:"'JetBrains Mono',monospace", fontWeight:500, borderRight:"1px solid var(--border)" }}>{row.uhid || "—"}</td>
                          ...
                          <td style={{ padding:"10px 14px", color:"var(--text-muted)", fontSize:12, fontFamily:"'JetBrains Mono',monospace", borderRight:"1px solid var(--border)" }}>{row.ipdNo || "—"}</td>
                          ...
                          <td style={{ padding:"10px 14px", color:"var(--text-mid)", fontSize:12, borderRight:"1px solid var(--border)" }}>{row.prepareBy || "—"}</td>

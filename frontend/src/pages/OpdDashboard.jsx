...
const blankRow = (sNo) => ({
  ...
  opdDate: "", uploadDate: new Date().toISOString().slice(0, 10),
  hospital: "", prepareBy: "", remarks: "", addedBy: "",
      ...
      <header style={{
        ...
        <div style={{ display:"flex", alignItems:"center", gap:14, flexShrink:0 }}>
          ...
          <div>
            ...
            <div style={{ fontSize:16, fontWeight:700, color:"var(--text)", letterSpacing:"-0.3px", whiteSpace:"nowrap" }}>OPD Department</div>
          </div>
          ...
          <div style={{ flex:1, overflow:"auto", padding:"20px 20px" }} className="ofade-in">
            ...
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:18, padding:"13px 18px", background:"var(--card)", border:`1.5px solid ${accent}40`, borderRadius:12, borderLeft:`5px solid ${accent}`, flexWrap:"wrap", gap:12 }}>
              <div>
                ...
                <div style={{ fontSize:11, color:"#9ca3af", marginTop:3 }}>Click any patient to view details and auto-fill today's OPD entry</div>
              </div>

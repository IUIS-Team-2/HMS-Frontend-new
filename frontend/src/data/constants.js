...
export const DEPARTMENTS = ["General Medicine", "Surgery", "Orthopaedics", "Gynaecology", "Paediatrics", "Cardiology", "ENT", "Emergency", "ICU"];
...
export const CSS = `/* Your existing CSS here */`;

/**
 * MANUAL LOGIN CREDENTIALS
 * -------------------------
 * Use these IDs and Passwords in the login screen:
 */
export const USERS = [
  { 
    id: 'superadmin', 
    ...
    password: 'super123', 
    role: 'superadmin', 
    locations: ['laxmi'] // Default landing location
  },
  { 
    id: 'admin_laxmi', 
